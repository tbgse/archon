...
const ssrRender = /* @__PURE__ */ _withId(function ssrRender2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><h1 data-v-7ba5bd90>A small state test for rehydration: ${renderer.ssrInterpolate($data.count)}</h1><button data-v-7ba5bd90>Add to count</button><nav data-v-7ba5bd90>`);
  ...
  return createRouter({
    ...
    routes: [
      {path: "/", component: () => Promise.resolve().then(function() {
        return require("./Homepage.464d9d0c.js");
      }), props: true},
      {path: "/a", component: () => Promise.resolve().then(function() {
        return require("./PageA.8f5165eb.js");
      }), props: true},
      {path: "/b", component: () => Promise.resolve().then(function() {
        return require("./PageB.bd903baf.js");
      }), props: true}
    ]
  });
}
...
<script type="module" src="/_assets/entry-client.42d76bd1.js"></script>
<link rel="stylesheet" href="/_assets/style.53f52550.css">
</head>
<body>
